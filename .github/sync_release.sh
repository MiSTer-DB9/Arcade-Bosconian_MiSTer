...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Arcade-Bosconian_MiSTer.git"
CORE_NAME=(Arcade-Bosconian)
...
UPSTREAM_CORE_NAME=(Arcade-Bosconian)
MAIN_BRANCH="master"
UPSTREAM_BRANCH="master"
COMPILATION_INPUT=(Arcade-Bosconian.qpf)
COMPILATION_OUTPUT=(output_files/Arcade-Bosconian.rbf)
